...
SECRET_KEY = 'django-insecure-h&b=-o2$o#r*tzieo_*%-3^&rmhd4y&%j!sm1zzgu6*#@kq9!r'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join( BASE_DIR, 'mobilestore/static')
]
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "MediaTech",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "MediaTech Admin",
